...
Route::get("/getformulatips",'App\Http\Controllers\QuestionController@getformulatips'); 
Route::get("/getflashcard",'App\Http\Controllers\QuestionController@getflashcard'); 
Route::get("/getFoundation",'App\Http\Controllers\QuestionController@getFoundation'); 
